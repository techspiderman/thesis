...
filenames = glob.glob('./data_rim/glaucoma/*')
...
img_save_dir = "./images_glaucoma_log"
save_dir_exists_flag = os.path.exists(img_save_dir)
if not save_dir_exists_flag :
...
plot_model(generator, to_file = data_path+ "/gen_plot.png", show_shapes=True, show_layer_names=True)
...
# Location to save images and logs
img_dir = "./images_glaucoma/"
save_dir_exists_flag = os.path.exists(img_dir)
if not save_dir_exists_flag :
    os.mkdir (img_dir)
...
generate_images(generator, img_dir)
